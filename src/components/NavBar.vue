                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <router-link class="nav-link" active-class="active"
                            :to="{ name: 'ranklist_index' }">对局列表</router-link>
                    </li>
                    <li class="nav-item">
                        <router-link :class="link_name === 'record_index' ? 'nav-link active' : 'nav-link'"
                            :to="{ name: 'record_index' }">排行榜</router-link>
                    </li>
                </ul>
...
export default {
    ...
    setup() {
        ...
        const link_name = computed(() => route.name);
